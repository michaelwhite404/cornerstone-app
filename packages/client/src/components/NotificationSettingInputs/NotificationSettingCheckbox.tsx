export function NotificationSettingCheckbox(props: NotificationSettingCheckboxProps) {
  ...
  return (
    <div className="flex items-center">
      <input
        ...
        type="checkbox"
        checked={checked}
        className="h-4 w-4 border-gray-300 rounded-md text-blue-600 focus:ring-blue-500 disabled:text-blue-200"
